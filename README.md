...
- **DualSense USB Bluetooth Bridge (Alpha)**
  ...
  - Compared with standard Android Bluetooth mode, the Bridge provides more detailed vibration, full gyro access, touchpad support, adaptive trigger effects, lightbar and player LED control, battery information, and shortcuts.
